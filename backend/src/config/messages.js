...
5. مسئولیت استفاده نادرست از اکانت بر عهده خریدار است.\n\n
    ...
    paymentProcessing: "⏳ در حال ایجاد لینک پرداخت...",
    paymentRedirectMessage: "✅ لینک پرداخت شما آماده است. روی دکمه زیر بزنید",
    ...
    paymentSuccess: "✅ *پرداخت شما با موفقیت انجام شد!*\n\n🔢 کد پیگیری: `{refID}`\n\n💳 مبلغ پرداختی به کیف پول شما اضافه شد.\n\n📅 تاریخ و زمان پرداخت: *{date}*\n\n✅ می‌توانید در قسمت کیف پول موجودی جدید خود را مشاهده کنید.\n\n🙏 از اعتماد شما سپاسگزاریم.",
    ...
    paymentError: "❌ خطا در ایجاد لینک پرداخت. لطفاً دوباره تلاش کنید."
}; 